		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 heading">
					<span class="title-icon pull-left"><i class="fa fa-users"></i></span>
					<h2 class="title">Registration<span class="title-desc">Choose member registration </span></h2>
				</div>
			</div><!-- Title row end -->
			...
			<div class="row text-center">
				<div class="col-md-4 col-sm-6">
					<div class="team wow slideInLeft">
                        <a href="register"><img src="<?php echo base_url(); ?>assets/img/select_member.png" alt="Image" class="img-responsive" style="width:100%"/> </a>
					</div>	
				</div><!--/ chooose 1 end -->
				<div class="col-md-4 col-sm-6">
					<div class="team wow slideInLeft">
                        <a href="register_trainer"><img src="<?php echo base_url(); ?>assets/img/select_trainer.png" class="img-responsive" style="width:100%" alt="Image"></a>
					</div>
				</div><!--/ chooose 2 end -->
				<div class="col-md-4 col-sm-6">
					<div class="team wow slideInRight">
                        <a href="register_fitness_center"><img src="<?php echo base_url(); ?>assets/img/select_fitness_center.png" class="img-responsive" style="width:100%" alt="Image"></a>
					</div>
				</div><!--/ chooose 3 end -->
