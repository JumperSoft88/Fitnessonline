...
<div class="container" >
    <div class="row" >
        <div class="col-md-10 ">
            <form class="form-horizontal" method="POST" action="register_fitness_center" >
                <fieldset>
                    <!-- Form Name -->
                    <legend>User profile fitness center form requirement</legend>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <label class="radio-inline" for="price" >
                                <input type="radio" name="price" id="price" value="2,000" checked="checked" >
                                CT_set A : ราย 6 เดือน 6,999 บาท
                            </label>
                            <label class="radio-inline" for="price" >
                                <input type="radio" name="price" id="price" value="2,000">
                                CT_set B : รายปี 9,999 บาท
                            </label>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="member_type" value="ftcenter">
