...
<body >  
    ...
    <section id="coachjoin" class="teamCoach">
		<div class="container">
            ...
            <form action="<?php echo base_url(); ?>fitness_join/fitness_regis" method="post"> 
                <div class="row">
                    <div class="col-md-10 mx-auto "> 
                        <div class="card">
                            <div class="card-header text-center">
                                Registration to Fitness!
                            </div> 
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="fullname" class="col-sm-3 col-form-label">บริษัท</label>
                                    <div class="col-sm-9">
