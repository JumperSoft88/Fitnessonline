<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="<?php echo base_url();?>auth/select_registration"><?=label("strRegister"); ?></a></li>
            <li><a href="<?php echo base_url();?>info/contact"><?=label("strContact"); ?></a></li>

            <?php if (isset($_SESSION['member_type'])) {  if($_SESSION['member_type'] == 'admin'){ ?>
                </li>
