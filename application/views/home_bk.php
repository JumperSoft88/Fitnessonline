							...
							<div class="carousel-item active text-center">
								<div class="row">
									<?php for ($x = 0; $x <= 3; $x++) { ?> 
										...
										<div class="col-md-3 mt-2"> 
											<div>
												<img  onclick="funcProfile(<?php echo $_SESSION['allTrainner'][$x]->member_id;?>,'trainner')" src="<?php echo base_url(); ?>/assets/images/coach/<?php echo $_SESSION['allTrainner'][$x]->username;?>.jpg"  alt="">
												<span class="img-top"></span>
												<span class="img-bottom"></span>
											</div>
											<div class="team-content">
												<h3>Vosgi Varduhi</h3>
												<p><i class="fa fa-eye" aria-hidden="true"></i>  <?php echo $_SESSION['allTrainner'][$x]->view;?> </p>
												<p>
													<?php
														for ($i = 0; $i < $_SESSION['allTrainner'][$x]->star; $i++){
												...
												<div class="team-social"> 
													...
													<?php  if($_SESSION['allTrainner'][$x]->facebook != null){	
														echo '<a class="fb" href="'.$_SESSION['allTrainner'][$x]->facebook.'"><i class="fa fa-facebook"></i></a>  ';
													}
													if($_SESSION['allTrainner'][$x]->line != null){
														echo '<a class="linkdin" href="'.$_SESSION['allTrainner'][$x]->line.'"><i class="fab fa-line"></i></a>  ';
													}

													if($_SESSION['allTrainner'][$x]->telephone != null){
														echo '<a class="gplus" href="tel:'.$_SESSION['allTrainner'][$x]->telephone.'"><i class="fa fa-phone"></i></a>  ';
													}
													?>
							...
							<div class="carousel-item text-center">
								<div class="row">
									<?php for ($x = 4; $x <= 7; $x++) { ?> 
										...
										<div class="col-md-3 mt-2"> 
											<div>
												<img src="<?php echo base_url(); ?>/assets/images/coach/<?php echo $_SESSION['allTrainner'][$x]->username;?>.jpg" alt="">
												<span class="img-top"></span>
												<span class="img-bottom"></span>
											</div>
											<div class="team-content">
												...
												<div class="team-social"> 
													...
													<?php  if($_SESSION['allTrainner'][$x]->facebook != null){	
														echo '<a class="fb" href="#"><i class="fa fa-facebook"></i></a>  ';
													}
													if($_SESSION['allTrainner'][$x]->line != null){
														echo '<a class="linkdin" href="#"><i class="fab fa-line"></i></a>  ';
													}

													if($_SESSION['allTrainner'][$x]->telephone != null){
														echo '<a class="gplus" href="#"><i class="fa fa-phone"></i></a>  ';
													}
													?> 
												</div>
											</div> 
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active text-center">
							...
							<?php for ($x = 8; $x <= 11; $x++) { ?> 
								...
								<?php if(!empty($_SESSION['allTrainner'][$x])){ ?>
									<div class="col-md-3 mt-2"> 
										<div>
											<img src="<?php echo base_url(); ?>/assets/images/coach/<?php echo $_SESSION['allTrainner'][$x]->username;?>.jpg" alt="">
											<span class="img-top"></span>
										...
										<div class="team-content">
											...
											<div class="team-social"> 
												...
												if($_SESSION['allTrainner'][$x]->line != null){
													echo '<a class="linkdin" href="#"><i class="fa fa-linkedin"></i></a>  ';
												}
  ...
  <!-- Start Fitness -->
    <section id="teamFitness" class="teamFitness">
		...
		<!-- Start slide fitness row1-->
			<div class="col-md-12">
                <div id="blogCarousel" class="carousel slide" data-ride="carousel"> 
				<span class="pull-right"><a class="btn btn-outline-info mt-2" href="<?php echo base_url(); ?>allFitness">All...</a></span>
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active text-center">
							...
							<?php for ($x = 0; $x <= 3; $x++) { ?> 
								...
								<div class="col-md-3 mt-2"> 
									<div>
										<img style="width:260px;height:260px;"  onclick="funcProfile(<?php echo $_SESSION['allFitness'][$x]->member_id;?>,'fitness')" src="<?php echo base_url(); ?>/assets/images/fitness/<?php echo $_SESSION['allFitness'][$x]->username;?>.png"  alt="">
										<span class="img-top"></span>
										<span class="img-bottom"></span>
									</div>
									<div class="team-content">
										<h3>Vosgi Varduhi</h3>
										<p><i class="fa fa-eye" aria-hidden="true"></i>  <?php echo $_SESSION['allFitness'][$x]->view;?> </p>
										<p>
											<?php
												for ($i = 0; $i < $_SESSION['allFitness'][$x]->star; $i++){
													echo '<i class="fa fa-star text-warning" aria-hidden="true"></i> ';
												}
											?> 
										</p>
										<div class="team-social"> 
											...
											<?php  if($_SESSION['allFitness'][$x]->facebook != null){	
												echo '<a class="fb" href="#"><i class="fa fa-facebook"></i></a>  ';
											}
											if($_SESSION['allFitness'][$x]->line != null){
												echo '<a class="linkdin" href="#"><i class="fab fa-line"></i></a>  ';
											}

											if($_SESSION['allFitness'][$x]->telephone != null){
												echo '<a class="gplus" href="#"><i class="fa fa-phone"></i></a>  ';
											}
											?>
                        ...
                        <div class="carousel-item text-center">
                            <div class="row">
                                <div class="col-md-3 mt-2">
									<div>
										<img style="width:260px;height:260px;" src="<?php echo base_url(); ?>/assets/images/slider/fitness/01-260x260_bk.png" alt="">
										<span class="img-top"></span>
										<span class="img-bottom"></span>
									</div>
									<div class="team-content">
            ...
            <div class="row text-center mt-3">
				...
				<div class="col-md-3 col-sm-6">
					<div class="team wow slideInLeft">
						<div >
							<img style="width:260px;height:260px;" src="<?php echo base_url(); ?>/assets/images/slider/fitness/02-260x260_bk.png" alt="">
							<span class="img-top"></span>
							<span class="img-bottom"></span>
						</div>
						<div class="team-content">
				...
				<div class="col-md-3 col-sm-6">
					<div class="team wow slideInRight">
						<div >
							<img style="width:260px;height:260px;"  src="<?php echo base_url(); ?>/assets/images/slider/fitness/03-260x260_bk.png" alt="">
							<span class="img-top"></span>
							<span class="img-bottom"></span>
						</div>
						<div class="team-content">
				...
				<div class="col-md-3 col-sm-6">
					<div class="team animate wow slideInRight">
						<div >
							<img style="width:260px;height:260px;" src="<?php echo base_url(); ?>/assets/images/slider/fitness/04-260x260_bk.png" alt="">
							<span class="img-top"></span>
							<span class="img-bottom"></span>
						</div>
						<div class="team-content">
...
<script>
							...
							<div class="portfolio-item mx-auto" data-toggle="modal" >
								...
								<div class="card text-white border-info mb-3">
									...
									<div class="card-body text-info">
										...
										<div class="row"> 
											<div><i class='fas fa-map-marker-alt mr-3' style='font-size:36px;color:orange'></i><label id="dataAddress"></label></div>
										</div>
										<div class="row mt-1">
											<div ><i class='fas fa-phone-square mr-3' style='font-size:36px;color:red'></i></i><label id="dataTel"></label></div> 
										</div>
										<div class="row mt-1">
											<div ><i class="fa fa-facebook-square mr-3" style="font-size:36px;color:blue"></i><label id="dataFb"></label></i></div>
								 
										</div>
										<div class="row mt-1">
											<div ><i class='fab fa-line  mr-3'style='font-size:36px;color:green'></i><label id="dataLine"></label></i></div> 
										</div>
									</div>
								</div>
	...
	<!-- <div class="col-md-6 col-lg-4 mb-5 mb-md-0">
								<div class="card border-info mx-sm-1 p-3"> 
									<img id="imageProfile" alt=""> 
								</div>
							</div>
							<div class="col-md-6 col-lg-4 mb-5 mb-md-0">
								<div class="card border-success mx-sm-1 p-3">
									<div class="card border-success shadow text-success p-3 my-card"><span class="fa fa-eye" aria-hidden="true"> Views</span></div>
									<div class="text-success text-center mt-1"><h4>9332</h4></div>
								</div>
								<div class="card border-warning mx-sm-1 p-3 mt-3">
									<div class="card border-warning shadow text-warning p-3 my-card" ><span class="fa fa-inbox" aria-hidden="true"> Stars</span></div>
									<div class="text-warning text-center mt-1"><h4>346</h4></div>
								</div>
							</div>
							<div class="col-md-6 col-lg-4 mb-5 mb-md-0"> 
								<div class="card border-info mx-sm-1 p-3">
			...
			//	dataType: "json",
				success: function(response) { 
				 //	alert('message : '+response['username']); 
					...
					if(type == 'trainner'){
						document.getElementById("imageProfile").src = "<?php echo base_url(); ?>/assets/images/coach/"+response['username']+".jpg";
					}else{
						document.getElementById("imageProfile").src = "<?php echo base_url(); ?>/assets/images/fitness/"+response['username']+".png";
					}
