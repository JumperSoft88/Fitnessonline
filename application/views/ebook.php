...
<nav class="navbar navbar-inverse" style="background-image: url(<?php echo base_url(); ?>assets/img/back_header.png)">
    <?php include("template/header_ebook.php") ?>
</nav>
...
<div class="container text-center">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <a href=""><img src="<?php echo base_url(); ?>assets/img/ebook.png" class="img-responsive" style="width:100%" alt="Image"></a>

        </div>
        <div class="col-sm-6">
            <a href=""><img src="<?php echo base_url(); ?>assets/img/Academic.png" class="img-responsive" style="width:100%" alt="Image"></a>
