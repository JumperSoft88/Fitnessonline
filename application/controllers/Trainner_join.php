...
class Trainner_join extends CI_Controller {
    ...
    {  
        ...
        $this->load->view('trainner_join',$data);
    }
    ...
    public function getAmphure()
    {
     ...
     public function trainner_regis()
     {
       /* echo $this->input->post('fullname').'\n';
        ...
        $this->auth_model->update_tbl_member_trainner_join($memb[0]->member_id,$data);
